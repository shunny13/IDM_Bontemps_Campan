...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(simpleWebsite.SimpleWebsitePackage.class)) {
            resourceSet.getPackageRegistry().put(simpleWebsite.SimpleWebsitePackage.eINSTANCE.getNsURI(), simpleWebsite.SimpleWebsitePackage.eINSTANCE);
        }
