 ...
 * @generated
 */
public class SimpleWebsitePackageImpl extends EPackageImpl implements SimpleWebsitePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see simpleWebsite.SimpleWebsitePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SimpleWebsitePackageImpl() {
		super(eNS_URI, SimpleWebsiteFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link SimpleWebsitePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SimpleWebsitePackage init() {
		if (isInited)
			return (SimpleWebsitePackage) EPackage.Registry.INSTANCE.getEPackage(SimpleWebsitePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSimpleWebsitePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SimpleWebsitePackageImpl theSimpleWebsitePackage = registeredSimpleWebsitePackage instanceof SimpleWebsitePackageImpl
				? (SimpleWebsitePackageImpl) registeredSimpleWebsitePackage
				: new SimpleWebsitePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theSimpleWebsitePackage.createPackageContents();

		// Initialize created meta-data
		theSimpleWebsitePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSimpleWebsitePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SimpleWebsitePackage.eNS_URI, theSimpleWebsitePackage);
		return theSimpleWebsitePackage;
	}
	 ...
	 */
	@Override
	public EAttribute getContent_Class() {
	 ...
	 */
	@Override
	public EAttribute getImage_Href() {
	 ...
	 */
	@Override
	public EReference getDiv_ContentInsideDiv() {
	 ...
	 */
	@Override
	public EReference getSection_ContentInsideSection() {
	 ...
	 */
	@Override
	public SimpleWebsiteFactory getSimpleWebsiteFactory() {
		return (SimpleWebsiteFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(contentEClass, CONTENT__CLASS);
		createEAttribute(contentEClass, CONTENT__ID);

		imageEClass = createEClass(IMAGE);
		createEAttribute(imageEClass, IMAGE__HREF);
		...
		createEReference(divEClass, DIV__CONTENT_INSIDE_DIV);
		...
		createEReference(sectionEClass, SECTION__CONTENT_INSIDE_SECTION);
	...
	public void initializePackageContents() {
		...
		divEClass.getESuperTypes().add(this.getContent());
		...
		scriptEClass.getESuperTypes().add(this.getContent());

		// Initialize classes, features, and operations; add parameters
		initEClass(websiteEClass, Website.class, "Website", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWebsite_Pages(), this.getPage(), null, "pages", null, 1, -1, Website.class, !IS_TRANSIENT,
		...
		initEAttribute(getPage_Lang(), ecorePackage.getEString(), "lang", null, 0, 1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPage_Content(), this.getContent(), null, "content", null, 0, -1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPage_Path(), ecorePackage.getEString(), "path", null, 0, 1, Page.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(contentEClass, Content.class, "Content", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getContent_Class(), ecorePackage.getEString(), "Class", null, 0, 1, Content.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContent_ID(), ecorePackage.getEString(), "ID", null, 0, 1, Content.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(imageEClass, Image.class, "Image", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getImage_Href(), ecorePackage.getEString(), "href", null, 0, 1, Image.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDiv_ContentInsideDiv(), this.getContent(), null, "contentInsideDiv", null, 0, -1, Div.class,
		...
		initEReference(getSection_ContentInsideSection(), this.getContent(), null, "contentInsideSection", null, 0, -1,
		...
		initEAttribute(getScript_Src(), ecorePackage.getEString(), "src", null, 0, 1, Script.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
