 ...
 * </p>
 * <ul>
 *   <li>{@link simpleWebsite.impl.ButtonImpl#getTargetPage <em>Target Page</em>}</li>
 *   <li>{@link simpleWebsite.impl.ButtonImpl#getTargetParagraph <em>Target Paragraph</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ButtonImpl extends ContentImpl implements Button {
	...
	protected EClass eStaticClass() {
		return SimpleWebsitePackage.Literals.BUTTON;
	}
		...
		if (targetPage != null && targetPage.eIsProxy()) {
			...
			if (targetPage != oldTargetPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleWebsitePackage.BUTTON__TARGET_PAGE,
	...
	public void setTargetPage(Page newTargetPage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleWebsitePackage.BUTTON__TARGET_PAGE,
					oldTargetPage, targetPage));
	}
			...
			if (targetParagraph != oldTargetParagraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimpleWebsitePackage.BUTTON__TARGET_PARAGRAPH, oldTargetParagraph, targetParagraph));
			}
		}
	...
	public void setTargetParagraph(Paragraph newTargetParagraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleWebsitePackage.BUTTON__TARGET_PARAGRAPH,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimpleWebsitePackage.BUTTON__TARGET_PAGE:
			if (resolve)
				return getTargetPage();
			return basicGetTargetPage();
		case SimpleWebsitePackage.BUTTON__TARGET_PARAGRAPH:
			if (resolve)
