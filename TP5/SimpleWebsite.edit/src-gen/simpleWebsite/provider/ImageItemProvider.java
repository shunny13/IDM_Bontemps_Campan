...
import simpleWebsite.Image;
import simpleWebsite.SimpleWebsitePackage;

/**
 * This is the item provider adapter for a {@link simpleWebsite.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends ContentItemProvider {
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Image_href_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Image_href_feature", "_UI_Image_type"),
						SimpleWebsitePackage.Literals.IMAGE__HREF, true, false, false,
	...
	protected void addAltPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SimpleWebsitePackage.Literals.IMAGE__ALT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case SimpleWebsitePackage.IMAGE__HREF:
		case SimpleWebsitePackage.IMAGE__ALT:
