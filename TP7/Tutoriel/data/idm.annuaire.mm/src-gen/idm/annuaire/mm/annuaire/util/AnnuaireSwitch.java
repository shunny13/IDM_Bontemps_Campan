 ...
 * @generated
 */
public class AnnuaireSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AnnuairePackage.PERSONS_LIBRARY: {
			PersonsLibrary personsLibrary = (PersonsLibrary) theEObject;
			T result = casePersonsLibrary(personsLibrary);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AnnuairePackage.BUILDING_LIBRARY: {
			BuildingLibrary buildingLibrary = (BuildingLibrary) theEObject;
			T result = caseBuildingLibrary(buildingLibrary);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Persons Library</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Persons Library</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersonsLibrary(PersonsLibrary object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Building Library</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Building Library</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBuildingLibrary(BuildingLibrary object) {
		return null;
	}
