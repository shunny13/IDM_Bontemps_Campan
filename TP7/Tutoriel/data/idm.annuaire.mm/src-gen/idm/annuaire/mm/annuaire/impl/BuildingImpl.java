 ...
 * </p>
 * <ul>
 *   <li>{@link idm.annuaire.mm.annuaire.impl.BuildingImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link idm.annuaire.mm.annuaire.impl.BuildingImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BuildingImpl extends MinimalEObjectImpl.Container implements Building {
	...
	protected EClass eStaticClass() {
		return AnnuairePackage.Literals.BUILDING;
	}
	...
	public EList<Address> getAddresses() {
		if (addresses == null) {
			addresses = new EObjectContainmentEList<Address>(Address.class, this, AnnuairePackage.BUILDING__ADDRESSES);
		}
		return addresses;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnnuairePackage.BUILDING__NAME, oldName, name));
	}
