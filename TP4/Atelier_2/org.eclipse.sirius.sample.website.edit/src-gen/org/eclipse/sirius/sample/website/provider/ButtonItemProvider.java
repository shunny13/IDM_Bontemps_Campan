...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.sample.website.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends ContentItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Button_targetPage_feature",
								"_UI_Button_type"),
						WebsitePackage.Literals.BUTTON__TARGET_PAGE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Button_targetParagraph_feature",
								"_UI_Button_type"),
						WebsitePackage.Literals.BUTTON__TARGET_PARAGRAPH, true, false, true, null, null, null));
	}
	...
	protected void addTargetExternalWebsitePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Button_targetExternalWebsite_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Button_targetExternalWebsite_feature",
								"_UI_Button_type"),
						WebsitePackage.Literals.BUTTON__TARGET_EXTERNAL_WEBSITE, true, false, true, null, null, null));
	}
