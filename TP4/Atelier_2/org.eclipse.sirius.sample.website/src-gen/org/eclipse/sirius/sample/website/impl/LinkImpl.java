 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.website.impl.LinkImpl#getTargetPage <em>Target Page</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.website.impl.LinkImpl#getTargetParagraph <em>Target Paragraph</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.website.impl.LinkImpl#getTargetExternalWebsite <em>Target External Website</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends ContentImpl implements Link {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.LINK;
	}
		...
		if (targetPage != null && targetPage.eIsProxy()) {
			...
			if (targetPage != oldTargetPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.LINK__TARGET_PAGE,
	...
	public void setTargetPage(Page newTargetPage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.LINK__TARGET_PAGE, oldTargetPage,
					targetPage));
	}
	...
	public Paragraph getTargetParagraph() {
		if (targetParagraph != null && targetParagraph.eIsProxy()) {
			...
			if (targetParagraph != oldTargetParagraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.LINK__TARGET_PARAGRAPH,
	...
	public void setTargetParagraph(Paragraph newTargetParagraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.LINK__TARGET_PARAGRAPH,
					oldTargetParagraph, targetParagraph));
	}
			...
			if (targetExternalWebsite != oldTargetExternalWebsite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							WebsitePackage.LINK__TARGET_EXTERNAL_WEBSITE, oldTargetExternalWebsite,
	...
	public void setTargetExternalWebsite(Website newTargetExternalWebsite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.LINK__TARGET_EXTERNAL_WEBSITE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WebsitePackage.LINK__TARGET_PAGE:
			if (resolve)
				return getTargetPage();
			return basicGetTargetPage();
		case WebsitePackage.LINK__TARGET_PARAGRAPH:
			if (resolve)
				return getTargetParagraph();
			return basicGetTargetParagraph();
		case WebsitePackage.LINK__TARGET_EXTERNAL_WEBSITE:
			if (resolve)
