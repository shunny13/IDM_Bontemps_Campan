 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.website.impl.PageImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	public EList<Content> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<Content>(Content.class, this, WebsitePackage.PAGE__CONTENT);
		}
		return content;
	}
