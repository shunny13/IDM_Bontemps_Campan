 ...
 * @generated
 */
public class BasicfamilyActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(BasicfamilyEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(BasicfamilyEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
