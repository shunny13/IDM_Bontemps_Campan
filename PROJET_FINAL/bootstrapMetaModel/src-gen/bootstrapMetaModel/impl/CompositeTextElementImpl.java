 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrapMetaModel.impl.CompositeTextElementImpl#getSubtext <em>Subtext</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CompositeTextElementImpl extends TextElementImpl implements CompositeTextElement {
	...
	protected EClass eStaticClass() {
		return BootstrapMetaModelPackage.Literals.COMPOSITE_TEXT_ELEMENT;
	}
	...
	public EList<TextElement> getSubtext() {
		if (subtext == null) {
			subtext = new EObjectContainmentEList<TextElement>(TextElement.class, this,
					BootstrapMetaModelPackage.COMPOSITE_TEXT_ELEMENT__SUBTEXT);
		}
		return subtext;
	}
