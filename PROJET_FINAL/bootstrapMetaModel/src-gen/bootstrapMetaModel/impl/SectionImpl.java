 ...
 * </p>
 * <ul>
 *   <li>{@link bootstrapMetaModel.impl.SectionImpl#getElement <em>Element</em>}</li>
 *   <li>{@link bootstrapMetaModel.impl.SectionImpl#getGrade <em>Grade</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SectionImpl extends ElementImpl implements Section {
	...
	protected EClass eStaticClass() {
		return BootstrapMetaModelPackage.Literals.SECTION;
	}
	...
	public EList<Element> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<Element>(Element.class, this,
					BootstrapMetaModelPackage.SECTION__ELEMENT);
		}
		return element;
	}
	...
	public void setGrade(int newGrade) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BootstrapMetaModelPackage.SECTION__GRADE, oldGrade,
					grade));
	}
