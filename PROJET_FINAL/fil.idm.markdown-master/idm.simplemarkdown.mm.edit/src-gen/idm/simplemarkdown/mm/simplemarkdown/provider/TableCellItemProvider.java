...
/**
 * This is the item provider adapter for a {@link idm.simplemarkdown.mm.simplemarkdown.TableCell} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableCellItemProvider extends TextContainerItemProvider {
	...
	protected void addIsHeaderPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TableCell_isHeader_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TableCell_isHeader_feature",
								"_UI_TableCell_type"),
						SimplemarkdownPackage.Literals.TABLE_CELL__IS_HEADER, true, false, false,
	...
	protected void addSpanPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TableCell_span_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TableCell_span_feature",
								"_UI_TableCell_type"),
						SimplemarkdownPackage.Literals.TABLE_CELL__SPAN, true, false, false,
	...
	protected void addAlignementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TableCell_alignement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TableCell_alignement_feature",
								"_UI_TableCell_type"),
						SimplemarkdownPackage.Literals.TABLE_CELL__ALIGNEMENT, true, false, false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_TableCell_type") + " " + tableCell.isIsHeader();
	}
