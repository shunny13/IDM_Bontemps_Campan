...
/**
 * This is the item provider adapter for a {@link idm.simplemarkdown.mm.simplemarkdown.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Document_name_feature",
								"_UI_Document_type"),
						SimplemarkdownPackage.Literals.DOCUMENT__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplemarkdownPackage.Literals.DOCUMENT__CONTENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case SimplemarkdownPackage.DOCUMENT__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case SimplemarkdownPackage.DOCUMENT__CONTENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SimplemarkdownPackage.Literals.DOCUMENT__CONTENTS,
		...
		newChildDescriptors.add(createChildParameter(SimplemarkdownPackage.Literals.DOCUMENT__CONTENTS,
				SimplemarkdownFactory.eINSTANCE.createReference()));

		newChildDescriptors.add(createChildParameter(SimplemarkdownPackage.Literals.DOCUMENT__CONTENTS,
				SimplemarkdownFactory.eINSTANCE.createTableBlock()));
