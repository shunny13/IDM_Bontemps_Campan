...
/**
 * This is the item provider adapter for a {@link idm.simplemarkdown.mm.simplemarkdown.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SimplemarkdownPackage.Literals.FOLDER__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplemarkdownPackage.Literals.FOLDER__DOCUMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case SimplemarkdownPackage.FOLDER__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case SimplemarkdownPackage.FOLDER__DOCUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SimplemarkdownPackage.Literals.FOLDER__DOCUMENTS,
				SimplemarkdownFactory.eINSTANCE.createDocument()));
	}
