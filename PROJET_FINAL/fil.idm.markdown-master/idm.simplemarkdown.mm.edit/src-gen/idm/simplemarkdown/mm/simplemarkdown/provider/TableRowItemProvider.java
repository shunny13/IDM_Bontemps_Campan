...
/**
 * This is the item provider adapter for a {@link idm.simplemarkdown.mm.simplemarkdown.TableRow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableRowItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRowNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TableRow_rowNumber_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TableRow_rowNumber_feature",
								"_UI_TableRow_type"),
						SimplemarkdownPackage.Literals.TABLE_ROW__ROW_NUMBER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplemarkdownPackage.Literals.TABLE_ROW__CELLS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_TableRow_type") + " " + tableRow.getRowNumber();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SimplemarkdownPackage.Literals.TABLE_ROW__CELLS,
				SimplemarkdownFactory.eINSTANCE.createTableCell()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return SimplemarkdownEditPlugin.INSTANCE;
	}
