 ...
 * </p>
 * <ul>
 *   <li>{@link idm.simplemarkdown.mm.simplemarkdown.impl.FolderImpl#getName <em>Name</em>}</li>
 *   <li>{@link idm.simplemarkdown.mm.simplemarkdown.impl.FolderImpl#getDocuments <em>Documents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FolderImpl extends MinimalEObjectImpl.Container implements Folder {
	...
	protected EClass eStaticClass() {
		return SimplemarkdownPackage.Literals.FOLDER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemarkdownPackage.FOLDER__NAME, oldName, name));
	}
	...
	public EList<Document> getDocuments() {
		if (documents == null) {
			documents = new EObjectContainmentEList<Document>(Document.class, this,
					SimplemarkdownPackage.FOLDER__DOCUMENTS);
		}
		return documents;
	}
