 ...
 * </p>
 * <ul>
 *   <li>{@link idm.simplemarkdown.mm.simplemarkdown.impl.ListImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ListImpl extends BlockImpl implements List {
	/**
	...
	protected EClass eStaticClass() {
		return SimplemarkdownPackage.Literals.LIST;
	}
	...
	public EList<ListItem> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<ListItem>(ListItem.class, this, SimplemarkdownPackage.LIST__ITEMS);
		}
		return items;
	}
