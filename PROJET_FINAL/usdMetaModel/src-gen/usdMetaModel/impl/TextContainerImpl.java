 ...
 * </p>
 * <ul>
 *   <li>{@link usdMetaModel.impl.TextContainerImpl#getTextelement <em>Textelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextContainerImpl extends ElementImpl implements TextContainer {
	...
	protected EClass eStaticClass() {
		return UsdMetaModelPackage.Literals.TEXT_CONTAINER;
	}
	...
	public EList<TextElement> getTextelement() {
		if (textelement == null) {
			textelement = new EObjectContainmentEList<TextElement>(TextElement.class, this,
					UsdMetaModelPackage.TEXT_CONTAINER__TEXTELEMENT);
		}
		return textelement;
	}
